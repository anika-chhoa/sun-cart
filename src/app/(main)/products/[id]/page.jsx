            ...
            <div className="flex flex-col gap-6">
              ...
              <span
                className={`w-2 h-2 rounded-full ${
                  targetProduct < 15 ? "bg-red-400" : "bg-emerald-400"
                }`}
              />
              <span
                className={`text-sm font-semibold ${
                  targetProduct.stock < 15 ? "text-red-400" : "text-emerald-500"
                }`}
              >
              ...
              <div className="grid grid-cols-3 gap-3 mt-2">
                <div
                    className="flex flex-col items-center gap-1.5 bg-white border border-orange-50 rounded-2xl py-3 px-2 text-center shadow-sm"
                  >
                    <span className="text-orange-400"><MdLocalShipping size={18}/></span>
                ...
                <div
                    className="flex flex-col items-center gap-1.5 bg-white border border-orange-50 rounded-2xl py-3 px-2 text-center shadow-sm"
                  >
                    <span className="text-orange-400"><MdVerified size={18} /></span>
                    <span className="text-xs font-semibold text-base-content/50">
                      Authentic
                    </span>
                  </div>
                <div
                    className="flex flex-col items-center gap-1.5 bg-white border border-orange-50 rounded-2xl py-3 px-2 text-center shadow-sm"
                  >
                    <span className="text-orange-400"><MdLoop size={18} /></span>
                    <span className="text-xs font-semibold text-base-content/50">
                      Easy Returns
                    </span>
                  </div>
