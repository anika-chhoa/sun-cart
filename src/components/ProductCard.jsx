...
const ProductCard = ({product}) => {
    return (
        <div
              ...
              className="card bg-white border border-orange-50 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-3xl overflow-hidden group"
            >
              <figure className="relative h-60 bg-amber-50/60 overflow-hidden">
                <Image
                  src={product.image}
                  alt={product.name}
                  fill
